...
probabilities = cell(n_samples*n_ppt,25,10);
            ...
            for start = 1:10
                ...
                if (~isempty(ppt_traj))
                    ...
                    for t = 1:time_steps_left
                        ...
                        p = SoftmaxMB(state, next_state, blief_map, gamma, A_allowed);
                        prob = [prob, p];

                    end
                end
                probabilities{agent_idx,config,start} = prob;
            end
        end
    end
end
