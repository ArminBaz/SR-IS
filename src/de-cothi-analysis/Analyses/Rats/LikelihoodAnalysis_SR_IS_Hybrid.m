...
hold on
set(gca, 'Color', 'w')
bar([1:5, 6.5:1:10.5], [median(trial_lliks1, 2); mean(trial_lliks2,2)],'EdgeColor','k','FaceColor','w','LineWidth',2)
...
xticklabels({'MF', 'MB','SR','Hybrid','SR-IS','MF', 'MB','SR','Hybrid','SR-IS'})
