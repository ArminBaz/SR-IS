...
[human_pd_sim_Q, human_pd_sim_MB, human_pd_sim_SR, human_pd_sim_SR_imp] = deal(cell(size(humans)));
...
for ppt = 1:18
    ...
    for config = 1:25
        ...
        for trial = 1:10
            ...
            [Q_pd_sim, MB_pd_sim, SR_pd_sim, SR_imp_pd_sim] = deal(zeros(100,length(reference_traj)));
            ...
            human_pd_sim_SR_imp{ppt,config,trial} = SR_imp_pd_sim;
        end
    end
end
