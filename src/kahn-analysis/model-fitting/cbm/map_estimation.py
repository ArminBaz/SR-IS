"""
MAP (Maximum A Posteriori) estimation using quadratic approximation.

This module provides the cbm_quad_lap function for single-subject optimization
using Laplace approximation.

Translated from MATLAB cbm_quad_lap.m
...
def log_posterior(parameters: np.ndarray,
    ...
    This is equivalent to MATLAB's neglogloggaussian function.
...
def optimize_map(data: Any,
    ...
    This is equivalent to MATLAB's cbm_quad_lap function.
